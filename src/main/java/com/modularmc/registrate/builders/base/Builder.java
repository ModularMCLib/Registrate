package com.modularmc.registrate.builders.base;
...
public interface Builder<R, T extends R, P, S extends Builder<R, T, P, S>> extends NonNullSupplier<RegistryEntry<R, T>> {
    ...
    /**
     * Remove the data provider callback for this entry for the given provider type, if one was previously configured.
     *
     * @param <D>
     *             The type of provider
     * @param type
     ...
     */
    @SuppressWarnings("unchecked")
    default <D> S removeData(GeneratorType<? extends D> type) {
